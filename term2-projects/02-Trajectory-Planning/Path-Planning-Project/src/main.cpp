...
int main() {
  ...
  PathPlanner path_planner = PathPlanner(map_waypoints_x, map_waypoints_y, map_waypoints_s);

  h.onMessage([&path_planner, &map_waypoints_x,&map_waypoints_y,&map_waypoints_s,
